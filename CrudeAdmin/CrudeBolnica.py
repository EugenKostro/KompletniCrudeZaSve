...
label = Label(root, text = "Sustav upravljanja bolnicama", font=('Arial Bold',30))
label.grid(row=0,column=0,columnspan=8,rowspan=2,padx=50,pady=40)

bolnicaIDLabel = Label(root,text = "id",font=('Arial',11))
bolnicaNazivLabel = Label(root,text = "Naziv bolnice",font=('Arial',11)) 
bolnicaAdresaLabel = Label(root,text = "Adresa bolnice",font=('Arial',11)) 
bolnicaGradLabel = Label(root,text = "Grad bolnice",font=('Arial',11)) 
bolnicaKontaktLabel = Label(root,text = "Kontakt bolnice",font=('Arial',11)) 
bolnicaEmailLabel = Label(root,text = "Email bolnice",font=('Arial',11)) 
bolnicaZalihaKrvneGrupeAPoz = Label(root,text= "A+",font=('Arial',11))
bolnicaZalihaKrvneGrupeANeg = Label(root,text= "A-",font=('Arial',11))
bolnicaZalihaKrvneGrupeBPoz = Label(root,text= "B+",font=('Arial',11))
bolnicaZalihaKrvneGrupeBNeg = Label(root,text= "B-",font=('Arial',11))
bolnicaZalihaKrvneGrupeABPoz = Label(root,text= "AB+",font=('Arial',11))
bolnicaZalihaKrvneGrupeABNeg = Label(root,text= "AB-",font=('Arial',11))
bolnicaZalihaKrvneGrupe0Poz = Label(root,text= "0+",font=('Arial',11))
bolnicaZalihaKrvneGrupe0Neg = Label(root,text= "0-",font=('Arial',11)) 
...
bolnicaIDEntry=Entry(root,width=55,bd=3,font=('Arial',11), textvariable=rezmj1Bolnica)
nazivEntry=Entry(root,width=55,bd=3,font=('Arial',11), textvariable=rezmj2Bolnica)
adresaEntry=Entry(root,width=55,bd=3,font=('Arial',11), textvariable=rezmj3Bolnica)
gradEntry=Entry(root,width=55,bd=3,font=('Arial',11), textvariable=rezmj4Bolnica)
kontaktEntry=Entry(root,width=55,bd=3,font=('Arial',11), textvariable=rezmj5Bolnica)
emailEntry=Entry(root,width=55,bd=3,font=('Arial',11), textvariable=rezmj6Bolnica)
zaliha_Krvne_Grupe_A_PozEntry=Entry(root,width=55,bd=3,font=('Arial',11), textvariable=rezmj7Bolnica)
zaliha_Krvne_Grupe_A_NegEntry=Entry(root,width=55,bd=3,font=('Arial',11), textvariable=rezmj8Bolnica)
zaliha_Krvne_Grupe_B_PozEntry=Entry(root,width=55,bd=3,font=('Arial',11), textvariable=rezmj9Bolnica)
zaliha_Krvne_Grupe_B_NegEntry=Entry(root,width=55,bd=3,font=('Arial',11), textvariable=rezmj10Bolnica)
zaliha_Krvne_Grupe_AB_PozEntry=Entry(root,width=55,bd=3,font=('Arial',11), textvariable=rezmj11Bolnica)
zaliha_Krvne_Grupe_AB_NegEntry=Entry(root,width=55,bd=3,font=('Arial',11), textvariable=rezmj12Bolnica)
zaliha_Krvne_Grupe_0_PozEntry=Entry(root,width=55,bd=3,font=('Arial',11), textvariable=rezmj13Bolnica)
zaliha_Krvne_Grupe_0_NegEntry=Entry(root,width=55,bd=3,font=('Arial',11), textvariable=rezmj14Bolnica)
...
addBtnBolnica=Button(root, text="Dodaj",padx=65,pady=25,width=10,bd=5,font=('Arial',15),bg="white",fg="red", command=addBolnica)
updateBtnBolnica=Button(root, text="Ažuriraj",padx=65,pady=25,width=10,bd=5,font=('Arial',15),bg="white",fg="red", command=updateBolnica)
deleteBtnBolnica=Button(root, text="Izbriši",padx=65,pady=25,width=10,bd=5,font=('Arial',15),bg="white",fg="red", command=deleteBolnica)
searchBtnBolnica=Button(root, text="Pretraži",padx=65,pady=25,width=10,bd=5,font=('Arial',15),bg="white",fg="red", command=searchBolnica)
resetBtnBolnica=Button(root, text="Resetiraj",padx=65,pady=25,width=10,bd=5,font=('Arial',15),bg="white",fg="red", command=resetBolnica)
selectBtnBolnica=Button(root, text="Izaberi",padx=65,pady=25,width=10,bd=5,font=('Arial',15),bg="white",fg="red", command=selectBolnica)

addBtnBolnica.grid(row=3,column=5,columnspan=1,rowspan=2)
updateBtnBolnica.grid(row=5,column=5,columnspan=1,rowspan=2)
deleteBtnBolnica.grid(row=7,column=5,columnspan=1,rowspan=2)
searchBtnBolnica.grid(row=9,column=5,columnspan=1,rowspan=2)
resetBtnBolnica.grid(row=11,column=5,columnspan=1,rowspan=2)
selectBtnBolnica.grid(row=13,column=5,columnspan=1,rowspan=2)

frame = tk.Frame(root)
frame.grid(column=1, row=30)

my_tree1 = ttk.Treeview(frame, columns=("id","naziv","adresa","grad","kontakt","email","zaliha_krvne_grupe_A_poz","zaliha_krvne_grupe_A_neg","zaliha_krvne_grupe_B_poz","zaliha_krvne_grupe_B_neg","zaliha_krvne_grupe_AB_poz","zaliha_krvne_grupe_AB_neg","zaliha_krvne_grupe_0_poz","zaliha_krvne_grupe_0_neg"), displaycolumns=("id","naziv","adresa","grad","kontakt","email","zaliha_krvne_grupe_A_poz","zaliha_krvne_grupe_A_neg","zaliha_krvne_grupe_B_poz","zaliha_krvne_grupe_B_neg","zaliha_krvne_grupe_AB_poz","zaliha_krvne_grupe_AB_neg","zaliha_krvne_grupe_0_poz","zaliha_krvne_grupe_0_neg"))
my_tree1.grid(column=1, row=2)
