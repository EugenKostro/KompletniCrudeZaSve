...
darivateljDatumRodenjaLabel = Label(root,text = "Datum rođenja",font=('Arial',10))
...
darivateljTjelesnaTezinaLabel = Label(root,text = "Težina",font=('Arial',10))
darivateljTjelesnaTemperaturaLabel = Label(root,text = "Temperatura",font=('Arial',10))
darivateljSistolickiKrvniTlakLabel = Label(root,text = "Sistolički tlak",font=('Arial',10))
darivateljDijastolickiKrvniTlakLabel = Label(root,text = "Dijastolički tlak",font=('Arial',10))
...
updateBtn=Button(root, text="Ažuriraj",padx=65,pady=25,width=10,bd=5,font=('Arial',15),bg="white",fg="red", command=updateDarivatelj)
deleteBtn=Button(root, text="Izbriši",padx=65,pady=25,width=10,bd=5,font=('Arial',15),bg="white",fg="red", command=deleteDarivatelj)
searchBtn=Button(root, text="Pretraži",padx=65,pady=25,width=10,bd=5,font=('Arial',15),bg="white",fg="red", command=searchDarivatelj)
resetBtn=Button(root, text="Resetiraj",padx=65,pady=25,width=10,bd=5,font=('Arial',15),bg="white",fg="red", command=resetDarivatelj)
