...
deleteBtnPrijevoznik=Button(root, text="Izbriši",padx=65,pady=25,width=10,bd=5,font=('Arial',15),bg="white",fg="red", command=deletePrijevoznik)
...
resetBtnPrijevoznik=Button(root, text="Resetiraj",padx=65,pady=25,width=10,bd=5,font=('Arial',15),bg="white",fg="red", command=resetPrijevoznik)
...
deleteBtnPrijevoznik.grid(row=7,column=5,columnspan=1,rowspan=2)
searchBtnPrijevoznik.grid(row=9,column=5,columnspan=1,rowspan=2)
resetBtnPrijevoznik.grid(row=11,column=5,columnspan=1,rowspan=2)
selectBtnPrijevoznik.grid(row=13,column=5,columnspan=1,rowspan=2)
